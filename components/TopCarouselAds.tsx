...
export default function TopCarouselAds() {
  ...
  // Helper function to format target URL with https:// if missing
  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 my-4">
      ...
      <div className="relative w-full aspect-[16/9] max-h-[450px] overflow-hidden rounded-xl shadow-md bg-black">
        {ads.map((ad, index) => {
          const finalTargetUrl = getFormattedUrl(ad.target_url)
          ...
          return (
            ...
            >
              <Link href={finalTargetUrl} target="_blank" rel="noopener noreferrer" className="w-full h-full flex items-center justify-center">
                <img
                  src={ad.banner_url}
